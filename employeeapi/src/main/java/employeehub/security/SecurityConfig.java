    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/employees/*/offboard").hasAnyRole("HR_ADMIN", "SUPER_ADMIN")
                        ...
                        .requestMatchers(HttpMethod.GET, "/leave/calendar").hasAnyRole("EMPLOYEE", "MANAGER", "HR_ADMIN", "SUPER_ADMIN")
                        .requestMatchers(HttpMethod.GET, "/leave/conflicts").hasAnyRole("EMPLOYEE", "MANAGER", "HR_ADMIN", "SUPER_ADMIN")
                        .requestMatchers(HttpMethod.GET, "/leave/types").authenticated()
                        .requestMatchers(HttpMethod.GET, "/leave/balances/forecast").authenticated()
                        ...
                        .requestMatchers(HttpMethod.POST, "/attendance/clock-in").authenticated()
                        .requestMatchers(HttpMethod.PATCH, "/attendance/clock-out").authenticated()
                        .requestMatchers(HttpMethod.GET, "/attendance/my").authenticated()
                        .requestMatchers(HttpMethod.GET, "/attendance").hasAnyRole("HR_ADMIN", "SUPER_ADMIN", "MANAGER")
